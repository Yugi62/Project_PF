...
public class Thunder : Skill
{
    ...
    private void Start()
    {
        projectile = Resources.Load<GameObject>("ThunderProjectile");
    ...
    {
        //1. 투사체 생성
        GameObject thunderProjectile = CreateProjectile();
        ...
        //3. 투사체 발사
        thunderProjectile.GetComponent<Projectile>().Shoot(target.position, transform.position, (int)transform.localScale.x);
    }
}
